 ...
 */
public final class StrategyFilterExampleJdk8_Step2
{
    ...
    public static void main(final String[] args)
    {
        ...
        // Step 2: Trick Nutzung der bisherigen Implementierung
        System.out.println("Filtering values for Intervall 2-7");
        final Predicate<Integer> closedInterval = value -> new ClosedInterval(2, 7).acceptValue(value);
        System.out.println("Using " + closedInterval + " " + filterAll(inputs, closedInterval));        
        final Predicate<Integer> openInterval = value -> new OpenInterval(2, 7).acceptValue(value);
