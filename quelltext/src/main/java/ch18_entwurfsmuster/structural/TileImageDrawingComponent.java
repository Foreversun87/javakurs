...
public final class TileImageDrawingComponent extends BaseDrawingComponent
{
    ...
    {
        final String[] tileFileNames = { "tiles/tile_gras_1.jpg", "tiles/tile_gras_2.jpg",
                        "tiles/tile_rock_1.jpg", "tiles/tile_rock_2.jpg", "tiles/tile_water.jpg" };
        ...
        {
            final File backgroundFile = new File("src/main/resources", tileFileNames[i]);
