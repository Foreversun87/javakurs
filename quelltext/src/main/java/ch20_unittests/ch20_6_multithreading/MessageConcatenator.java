...
{
    private static final Logger log                      = LogManager.getLogger(MessageConcatenator.class);

    // maximale Telegrammlï¿½nge hier auf 250 Bytes begrenzt
     ...
     */
    public synchronized void sendMessage(final DisplayMsg sendMsg)
    {
    ...
    private synchronized void flushImpl()
    {
        if (getBufferedMsgLength() > 0)
        {
            ...
            display.displayMsg(cumulatedMsg);
        }
