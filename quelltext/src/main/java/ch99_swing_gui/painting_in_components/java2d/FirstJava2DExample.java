...
/**
 * Beispielklasse zur Demonstration einiger Möglichkeiten von Java2D.
 *
 ...
 */
public final class FirstJava2DExample
{
    public static void main(final String[] args)
    {
        final JFrame appFrame = new JFrame("FirstJava2DExample");
        appFrame.setDefaultCloseOperation(JFrame.DISPOSE_ON_CLOSE);

        appFrame.add(new DrawingComponent(), BorderLayout.CENTER);

        appFrame.setSize(250, 240);
