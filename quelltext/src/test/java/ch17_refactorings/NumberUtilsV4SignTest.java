...
public class NumberUtilsV4SignTest 
{
	...
	{
		assertTrue("plus sign should be accepted", NumberUtilsV4CombinedConditions.isNumber("+4711"));
	}

	@Test
	public void testNumberNegative() 
	{
		assertTrue("minus sign should be accepted", NumberUtilsV4CombinedConditions.isNumber("-4711"));
	}
}