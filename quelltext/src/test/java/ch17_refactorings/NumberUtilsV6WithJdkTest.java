...
/**
 * Beispiel eines einfachen Unit Tests für die sechste Version der Klasse NumberUtils 
 * 
 * @author Michael Inden
 * 
 * Copyright 2011, 2014 by Michael Inden 
 */
public class NumberUtilsV6WithJdkTest
{
	@Test
    public void testValidNumberInput()
    {
        assertTrue(NumberUtilsV6WithJdk.isNumber("12345"));
    }

	@Test
    public void testInvalidInput()
    {
        assertFalse(NumberUtilsV6WithJdk.isNumber("ABC"));
    }
    ...
    {
        assertFalse(NumberUtilsV6WithJdk.isNumber(""));
    }

	@Test
    public void testNumberInputLength1()
    {
        assertTrue(NumberUtilsV6WithJdk.isNumber("1"));
    }
    ...
    public void testNullInput()
    {
        try
        {
        	NumberUtilsV6WithJdk.isNumber(null);
	...
	{
		assertTrue("plus sign should be accepted", NumberUtilsV6WithJdk.isNumber("+4711"));
	}

	@Test
	public void testNumberNegative() 
	{
		assertTrue("minus sign should be accepted", NumberUtilsV6WithJdk.isNumber("-4711"));
	}
}