...
import static ch20_unittests.basics.DiscountCalculatorV3.BIG_DISCOUNT;
import static ch20_unittests.basics.DiscountCalculatorV3.MEDIUM_DISCOUNT;
import static ch20_unittests.basics.DiscountCalculatorV3.NO_DISCOUNT;
import static org.junit.Assert.assertEquals;

import org.junit.Test;

/**
 * Unit-Tests zu der Utility-Klasse DiscountCalculatorV3.
 * 
 * @author Michael Inden
 * 
 * Copyright 2014, 2017 by Michael Inden 
 */
public class DiscountCalculatorV3Test 
{
	private final DiscountCalculatorV3 calculator = new DiscountCalculatorV3();
